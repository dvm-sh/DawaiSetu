...
import { Heart, ArrowRight, Shield, Truck, Users, BarChart3, CheckCircle2, Pill, Building2, Recycle, Search, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors">
      ...
      <section className="pt-24 pb-16 sm:pt-32 sm:pb-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-teal-50 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-800 rounded-full text-sm text-teal-700 dark:text-teal-300 font-medium mb-6">
            <Heart className="h-4 w-4" />
            Reducing medicine waste, saving lives
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 max-w-4xl mx-auto leading-tight">
            Smart Medicine
            <span className="text-teal-600 dark:text-teal-400"> Redistribution</span> Platform
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/how-it-works" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium rounded-xl border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              See How It Works
            </Link>
          </div>
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm text-gray-500 dark:text-gray-400">
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-teal-600 dark:text-teal-400" /> Verified Organizations</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-teal-600 dark:text-teal-400" /> Expiry Tracking</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-teal-600 dark:text-teal-400" /> Smart Matching</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-teal-600 dark:text-teal-400" /> End-to-End Tracking</div>
          </div>
        </div>
      </section>

      {/* How It Works */}
      <section className="py-16 sm:py-24 bg-gray-50 dark:bg-gray-900 px-4 transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100">How DawaiSetu Works</h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">A seamless 4-step process to redistribute surplus medicines</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.step} className="relative bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 hover:border-teal-200 dark:hover:border-teal-800 hover:shadow-lg transition-all group">
                <span className="text-5xl font-bold text-gray-100 dark:text-gray-700/60 group-hover:text-teal-50 dark:group-hover:text-teal-950/50 transition-colors absolute top-4 right-4">{item.step}</span>
                <div className="w-12 h-12 bg-teal-50 dark:bg-teal-950/50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-teal-100 dark:group-hover:bg-teal-900/60 transition-colors">
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-6">The Medicine Waste Crisis</h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={stat} className="flex items-start gap-3">
                    <div className="mt-1 w-5 h-5 bg-red-100 dark:bg-red-950/60 rounded-full flex items-center justify-center shrink-0">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-950/30 dark:to-emerald-950/20 border border-teal-100 dark:border-teal-900/40 rounded-3xl p-8 lg:p-12">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Our Solution</h3>
      ...
      <section className="py-16 sm:py-24 bg-gray-50 dark:bg-gray-900 px-4 transition-colors">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Platform Benefits</h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-16">For donors, recipients, and the community</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={section.title} className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-left">
                <div className="w-12 h-12 bg-teal-50 dark:bg-teal-950/50 rounded-xl flex items-center justify-center mb-4">
                  <section.icon className="h-6 w-6 text-teal-600 dark:text-teal-400" />
                </div>
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 rounded-full text-sm text-emerald-700 dark:text-emerald-300 font-medium mb-6">
            <Shield className="h-4 w-4" /> Safety First
          </div>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Built with Safety & Trust</h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-12">Every step of the process is verified and tracked</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
